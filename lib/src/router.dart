...
class VRouterState extends State<VRouter> {
  ...
  Future<void> _updateUrl(
    ...
    if (url != newUrl || newRouterState != historyState) {
  ...
  Future<void> _pop({
    ...
    if (vRedirector != null) {
      _updateUrl(vRedirector.to, queryParameters: queryParameters, newState: {'-2': newState});
    } else if (!kIsWeb) {
  ...
  VRedirector _defaultPop({
    ...
    var newPathParameters =
        (newMatch != null) ? extract(newVRoutePath.parameters, newMatch) : <String, String>{};
    // Decode path parameters
    newPathParameters =
        newPathParameters.map((key, value) => MapEntry(key, Uri.decodeComponent(value)));
...
class VRouterData extends InheritedWidget {
  ...
  String get previousUrl => _state.previousUrl;
  ...
  ///      version of the historyState
  String get historyState => _state.historyState;
  ...
  void pop({
    ...
    String routerState,
      ...
      _state.pop(queryParameters: queryParameters, routerState: routerState);
  ...
  Future<void> systemPop({
    ...
    String routerState,
      ...
      _state.systemPop(queryParameters: queryParameters, routerState: routerState);
